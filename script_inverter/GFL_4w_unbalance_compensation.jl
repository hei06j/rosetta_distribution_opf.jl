...
# for objective in ["VUF"]
    ...
    vr_vals = value.(vr)
    vi_vals = value.(vi)
    v1 = Array(vr_vals[:,gen_bus_id] + im * vi_vals[:,gen_bus_id])
    vm1 = abs.(v1)
    # va1 = angle.(v1).*180/pi
    ...
    cg1 = Array(crg_values[:,gen_id] + im * cig_values[:,gen_id])
    cgm1 = abs.(cg1)
    cg1_012 = T * cg1[1:3]
    ...
    results_GFL_4w[objective]["v_gen"] = v1
    results_GFL_4w[objective]["v_gen_012"] = v1_012
    results_GFL_4w[objective]["c_gen"] = cg1
    results_GFL_4w[objective]["c_gen_012"] = cg1_012
    results_GFL_4w[objective]["c_load"] = cd1
    results_GFL_4w[objective]["c_load_012"] = cd1_012
    results_GFL_4w[objective]["c_branch"] = c1
    results_GFL_4w[objective]["c_branch_012"] = c1_012
    results_GFL_4w[objective]["sg_gen"] = Array(value.(pg)[:,1] .+ im * value.(qg)[:,1])
    results_GFL_4w[objective]["sg_source"] = Array(value.(pg)[:,2] .+ im * value.(qg)[:,2])
# end
...
# v_zero_seq = [results_GFL_4w[obj]["v_gen_012"][1] for obj in objectives]
# v_positive_seq = [results_GFL_4w[obj]["v_gen_012"][2] for obj in objectives]
# v_negative_seq = [results_GFL_4w[obj]["v_gen_012"][3] for obj in objectives]
# cg_zero_seq = [results_GFL_4w[obj]["c_gen_012"][1] for obj in objectives]
# cg_positive_seq = [results_GFL_4w[obj]["c_gen_012"][2] for obj in objectives]
# cg_negative_seq = [results_GFL_4w[obj]["c_gen_012"][3] for obj in objectives]
