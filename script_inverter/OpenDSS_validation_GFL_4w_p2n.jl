...
##
ODSS.dss("Redirect ./data/test_gen_4w_wye_InvControl_p2n.dss")
vm_Control_p2n = ODSS.Circuit.AllBusVolts()
cm_Control_p2n = ODSS.PDElements.AllCurrentsAllCurrents()
cm1_Control_p2n = ODSS.PDElements.AllCurrentsAllCurrents()[5:8]
cm2_Control_p2n = ODSS.PDElements.AllCurrentsAllCurrents()[13:16]
vm1_Control_p2n = abs.(vm_Control_p2n)[1:3]./230.94
vm2_Control_p2n = abs.(vm_Control_p2n)[4:7]./230.94
vm3_Control_p2n = abs.(vm_Control_p2n)[8:10]./230.94
pg_Control_p2n = ODSS.PVsystems.kW()
qg_Control_p2n = ODSS.PVsystems.kvar()
...
##
data_path = "./data/test_gen_4w_wye_p2n.dss"
...
##
@show [round.(vm2_Control_p2n, digits=4) ; sum(qg3)]
